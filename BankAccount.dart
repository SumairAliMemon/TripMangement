...
import 'package:flutterapp/tripapp/EasyPaisa/EasyPaisa.dart';
      ...
      child: Stack(
          ...
          children: [
            Positioned(
                left: 10.0,
                top: 20.0,
                child:  BoldText(text: 'Pay Through Bank Account',)
            ),
            Positioned(
                left: 10.0,
                top: 70.0,
                child:  BoldText(text: 'Bank Name:',)
            ),
            Positioned(
                left: 10.0,
                top: 95.0,
                child:  NormalText(text: 'Habib Bank Limited',)
            ),
            Positioned(
                left: 10.0,
                top: 145.0,
            ...
            Positioned(
                left: 10.0,
                top: 170.0,
                child:  NormalText(text: '468253964724392',)
            ),
            Positioned(
                left: 10.0,
                top: 220.0,
                child:  BoldText(text: 'IBAN:',)
            ),
            Positioned(
                left: 10.0,
                top: 245.0,
                child:  NormalText(text: 'PK5832928593754',)
            ),
            Positioned(
              left: 45.0,
              top: 275.0,
